...
export const metadata = {
    title: 'Mutal de Seguros | Fundación Apoyándote'
};
    ...
    return (
        ...
        <main className="text-center">
            ...
            <section className=" text-center mt-20 mb-24 max-w-screen-lg mx-auto">
                ...
                <TablaPreciosMutual />
                <p className=" text-center m-8 px-8 max-w-screen-sm mx-auto"><Boton enlace='https://core.mutualdeseguros.cl/soap_ms/pago.php?tipodeventa=244' texto='Paga tu SOAP aquí' /></p>
            </section>
